<ul>
    ...
    @endphp
        ...
        @foreach ($items as $item)
            ...
            <li class="{{ $isActive }}">
{{-- if i want to change the link of the profile pdf file then i have to go to database and change 
the column of link there and the title  --}}

{{-- here to add lang to english 
